...
public class DBHelperElectronics extends SQLiteOpenHelper {
   ...
   public DBHelperElectronics(Context context) {
   ...
   public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
      // TODO Auto-generated method stub,
      //db.execSQL("DROP TABLE IF EXISTS electronics");
      onCreate(db);
   }
   ...
   public boolean insertProblem (String question, String solution, String option1, String option2,String option3) {
      ...
      db.insert("electronics", null, contentValues);
      return true;
   }
   
   public Cursor getData(int id) {
      SQLiteDatabase db = this.getReadableDatabase();
      Cursor res =  db.rawQuery( "select * from electronics where id="+id+"", null );
      return res;
   }
   
   public int numberOfRows(){
      SQLiteDatabase db = this.getReadableDatabase();
      int numRows = (int) DatabaseUtils.queryNumEntries(db, ELECTRONICS_TABLE_NAME);
      return numRows;
   }
   ...
   public ArrayList<String> getAllCotacts() {
      ...
      //hp = new HashMap();
      SQLiteDatabase db = this.getReadableDatabase();
      Cursor res =  db.rawQuery( "select * from electronics", null );
      res.moveToFirst();
